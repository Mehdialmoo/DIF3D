...
from trutil import remove_background, resize_foreground, save_video
...
parser.add_argument(
    ...
    Could be either a huggingface model id is or a local path. Default: 'stabilityai/TripoSR'",
)
parser.add_argument(
    "--chunk-size",
    default=8192,
    ...
    help="Evaluation chunk size for surface extraction and rendering.\
        Smaller chunk size reduces VRAM usage but increases computation time. 0 for no chunking. Default: 8192",
)
parser.add_argument(
    "--mc-resolution",
    default=256,
